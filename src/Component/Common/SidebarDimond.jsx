...
const SidebarDimond = () => {
  ...
  return (
    ...
    <div className='fixed inset-0 z-100' style={{display:"none"}}>
      ...
      <button type="button" className="bg-transparent absolute top-1 right-1 z-10 border-none outline-none w-9 h-9 text-black"><svg class="block w-full h-full" aria-hidden="true" focusable="false" viewBox="0 0 36 36"><svg width="36" height="36" viewBox="0 0 36 36" fill="none" xmlns="http://www.w3.org/2000/svg"><g><path d="M12.6201 12.62L23.3799 23.3798" stroke="currentColor" stroke-miterlimit="10"></path><path d="M12.6201 23.3798L23.3799 12.62" stroke="currentColor" stroke-miterlimit="10"></path></g></svg></svg></button>
    ...
    <div className="px-3 pt-2 pb-3 shrink-0 border-borders border-b">
        <div className="text-1.5xl text-black leading-tight">0.5 Carat I VS2 Round Natural Diamond</div>
        <div className="mt-1 leading-tight flex items-center gap-1.5 flex-wrap">
          <div className="text-lg leading-tight
              text-customGray-500">$736</div>
        </div>
    </div>
    <div className="flex-1 overflow-auto hiddenScroll px-3 pt-3 pb-21" data-scroll-lock-scrollable="true">
        <div className="p-2 bg-customGray-50 rounded-2xl grid grid-cols-2 gap-2">
          <div className="flex items-center gap-2 col-span-2">
              ...
              <div className="text-black text-base leading-tight font-medium">Know your stone</div>
          </div>
          ...
          <div className="rounded-xl bg-white shadow-3sc-tile p-2.5 flex flex-col justify-between min-h-[5rem]">
              <div className="flex items-center w-full gap-1">
                <svg className="block w-4 h-4" aria-hidden="true" focusable="false" viewBox="0 0 17 16">
                    <svg width="17" height="16" viewBox="0 0 17 16" fill="none" xmlns="http://www.w3.org/2000/svg">
                      <g>
                          <path d="M1.50781 7.30243L4.37667 4.43262H10.4437L13.3126 7.30243L7.40733 12.5404L1.50781 7.30243Z" stroke="#1A93C7" stroke-width="0.75" stroke-miterlimit="10"></path>
                          <path d="M5.17558 7.23696L7.10057 10.3052L3.81494 7.38886L5.47519 5.72852L5.17558 7.23696Z" fill="#1A93C7"></path>
                          <path d="M7.40771 12.4684L10.0354 7.32795L8.02057 4.44141" stroke="#1A93C7" stroke-width="0.75" stroke-miterlimit="10"></path>
                          <path d="M15.2645 9.25526L7.71191 1.7002" stroke="#1A93C7" stroke-width="0.75" stroke-miterlimit="10"></path>
                          <path d="M5.42334 14.3001L15.4926 5.36865" stroke="#1A93C7" stroke-width="0.75" stroke-miterlimit="10"></path>
                      </g>
                    </svg>
                </svg>
                <div className="text-1.25xs leading-none text-customGray-400 uppercase font-semibold">Cut</div>
              </div>
              <div className="text-black font-bold text-base leading-tight">Excellent</div>
          </div>
          <div className="rounded-xl bg-white shadow-3sc-tile p-2.5 flex flex-col justify-between min-h-[5rem]">
              <div className="flex items-center w-full gap-1">
                <svg className="block w-4 h-4" aria-hidden="true" focusable="false" viewBox="0 0 17 16">
              ...
              <div className="text-black font-bold text-base leading-tight">5.09x5.06</div>
          </div>
          <div className="rounded-xl bg-white shadow-3sc-tile p-2.5 flex flex-col justify-between min-h-[5rem]">
              <div className="flex items-center w-full gap-1">
                <svg className="block w-4 h-4" aria-hidden="true" focusable="false" viewBox="0 0 17 16">
                    <svg viewBox="0 0 17 16" fill="none" xmlns="http://www.w3.org/2000/svg">
                      <path d="M8.93758 2.02284L9.9586 2.67902H11.1723L11.6765 3.78303L12.6975 4.4392L12.5248 5.64054L13.029 6.74455L12.2342 7.6618L12.0614 8.86314L10.8969 9.20508L10.1021 10.1223L8.93758 9.78039L7.77305 10.1223L6.97825 9.20508L5.81372 8.86314L5.641 7.6618L4.84619 6.74455L5.35038 5.64054L5.17765 4.4392L6.19868 3.78303L6.70287 2.67902H7.91655L8.93758 2.02284Z" stroke="#CEA100" stroke-width="0.75" stroke-miterlimit="10"></path>
                      <path d="M9.82104 11.1904L10.8769 13.0228L11.4964 11.5972L13.0402 11.7736L12.009 9.98737" stroke="#CEA100" stroke-width="0.75" stroke-miterlimit="10"></path>
                      <path d="M8.05493 11.1889L6.99824 13.0228L6.37875 11.5972L4.83496 11.7736L5.86612 9.98737" stroke="#CEA100" stroke-width="0.75" stroke-miterlimit="10"></path>
                    </svg>
                </svg>
                <div className="text-1.25xs leading-none text-customGray-400 uppercase font-semibold">Certification</div>
              </div>
              <div className="text-black font-bold text-base leading-tight">GIA</div>
          </div>
        </div>
    </div>
    <div className="flex justify-center gap-2 flex-wrap p-3 fixed bottom-0 left-0 right-0 z-10 md:flex-col-reverse max-w-[300px]">
        <button type="button" className="w-12 h-12 md:h-auto md:w-full rounded-full text-base font-semibold leading-tight bg-white text-black md:p-2 text-center flex justify-center items-center border-2 border-black md:px-5 shadow-floating-button md:shadow-none">
        ...
        <a className="grow rounded-full text-base font-semibold leading-tight bg-black text-white p-3.5 text-center flex justify-center items-center md:w-full md:px-5 md:font-normal shadow-floating-button md:shadow-none" href="/products/0-50-round-i-vs2-hrnd-round-gia-6502845655" aria-hidden="false">
