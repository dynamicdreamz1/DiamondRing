                    ...
                    <div className="cpst-tab-content-wrapper text-customGray-450 py-4 pr-10 pl-3">
                        ...
                        <div className="cpcst-details-wrapper flex-1">
                                <div className="cpcst-details flex whitespace-nowrap gap-5">
                                    ...
                                    <div className="cpcst-details-value">0.5</div>
                                    <div className="cpcst-details-value">Round</div>
                                    <div className="cpcst-details-value">F</div>
                                    <div className="cpcst-details-value">VVS2</div>
                                    <div className="cpcst-details-value">4.9/4.88</div>
                                    <div className="cpcst-details-value">1</div>
                                    <div className="cpcst-details-value">Good</div>
                                    </div>
                                </div>
                            ...
                            <div className='MoissaniteDetails__certificate w-1/2'>
                                <a className="cursor-pointer block h-full" href="https://www.gia.edu/report-check?reportno=5216550995" target="_blank" title="opens in a new tab" aria-hidden="false" data-equally-tooltip="Opens in new window">
                                    ...
                                    <div className="cpcst-certificate-wrapper text-center">
                                        <div className="cpcst-certificate-title whitespace-pre-line">Natural
                                            Diamond
                                        </div>
                                        <div className="cpcst-certificate-image-wrapper w-20 h-20 relative mx-auto"><img className="cpcst-certificate-image absolute w-full h-full object-contain top-0 left-0" loading="lazy" src="https://cdn.shopify.com/oxygen-v2/24658/9071/18525/1168911/build/_assets/kzr-icon-gia-crt-N3UI7WNQ.svg" width="150" height="150" alt="Certificate image"/></div>
