    ...
    <div className="min-h-screen bg-white">
      ...
      <div className="container mx-auto px-4 py-8">
        <div className="flex items-center justify-between">
          ...
          <div class="step-config-number text-2xl leading-none md:text-4.25xl basis-4 shrink-0 font-normal">1</div>
            <div className="ml-2 text-left step-config-titles overflow-hidden whitespace-nowrap">
              <div className="text-sm text-gray-500 text-ellipsis overflow-hidden">Select your</div>
              <div className="font-semibold text-ellipsis overflow-hidden">SETTING</div>
            </div>
            <div class="step-config-product-details flex-1 hidden text-right lg:block overflow-hidden py-2"><div class="step-config-product-title text-xs text-black leading-1.1 whitespace-nowrap overflow-hidden text-ellipsis mb-1.5">0.5 Carat I VS2 Round Natural Diamond</div><div class="step-config-price-and-buttons flex gap-2 items-center justify-end"><button type="button" class="text-customGray-200 underline text-xs leading-none">View</button><div class="step-config-price text-customGray-400 text-xs leading-tight hidden lg:block"><div>$736</div></div></div></div>
            <div class="step-config-image-container"><div class="step-config-image relative w-5 h-5 md:w-10 md:h-14"><svg class="absolute w-full h-full -translate-x-1/2 -translate-y-1/2 top-1/2 left-1/2 md:w-3/4 md:h-3/4" aria-hidden="true" focusable="false"><svg viewBox="0 0 29 28" fill="none" xmlns="http://www.w3.org/2000/svg"><rect x="1.16663" y="0.5" width="27" height="27" rx="13.5" fill="#EBFAE8"></rect><rect x="1.16663" y="0.5" width="27" height="27" rx="13.5" stroke="#58A23E"></rect><path d="M20.1666 10.6957L13.558 17.3044L9.16663 12.913" stroke="#58A23E" stroke-miterlimit="10"></path></svg></svg></div></div>
          ...
          <div class="step-config-number text-2xl leading-none md:text-4.25xl basis-4 shrink-0 font-semibold">2</div>
            <div className="ml-2 text-left step-config-titles overflow-hidden whitespace-nowrap">
              <div className="text-sm text-gray-500 text-ellipsis overflow-hidden">Select your</div>
              <div className="font-semibold text-ellipsis overflow-hidden">STONE</div>
            </div>
            <div class="step-config-product-details flex-1 hidden text-right lg:block overflow-hidden py-2"><div class="step-config-product-title text-xs text-black leading-1.1 whitespace-nowrap overflow-hidden text-ellipsis mb-1.5">The Lexie</div><div class="step-config-price-and-buttons flex gap-2 items-center justify-end"><button type="button" class="text-customGray-200 underline text-xs leading-none">Change</button><div class="step-config-price text-customGray-400 text-xs leading-tight hidden lg:block"><div>$750</div></div></div></div>
            <div class="step-config-image-container"><div class="step-config-image relative w-5 h-5 md:w-10 md:h-14"><svg class="absolute w-full h-full -translate-x-1/2 -translate-y-1/2 top-1/2 left-1/2 md:w-3/4 md:h-3/4" aria-hidden="true" focusable="false"><svg viewBox="0 0 29 28" fill="none" xmlns="http://www.w3.org/2000/svg"><rect x="1.16663" y="0.5" width="27" height="27" rx="13.5" fill="#EBFAE8"></rect><rect x="1.16663" y="0.5" width="27" height="27" rx="13.5" stroke="#58A23E"></rect><path d="M20.1666 10.6957L13.558 17.3044L9.16663 12.913" stroke="#58A23E" stroke-miterlimit="10"></path></svg></svg></div></div>
...
<div class="px-5 md:pb-6"><header class="max-w-7xl mx-auto text-center"><h1 class="text-black font-semibold text-1.5lg leading-none mb-1.5 md:text-3xl md:mb-2.5" tabindex="-1">Engagement Rings</h1><p class="leading-tighter text-black/50 text-1.5sm md:text-xl" tabindex="-1">Discover our collection of made to order engagement rings and customize it to your preference</p></header></div>
        ...
        <div className="md:w-full gap-2 whitespace-nowrap snap-start hiddenScroll overflow-x-auto overflow-y-hidden scroll-smooth p-px md:p-0.5 grid grid-cols-4 md:flex md:gap-6 md:justify-center md:snap-center">
          {ringStyles.map((style) => (
            <div key={style.id} className="text-center ring-1 ring-black md:ring-2 pt-1.25 p-2 pb-1.75 md:min-w-[6rem] md:p-3 md:pt-1.5 md:border-none text-center text-black select-none rounded-lg border transition-colors bg-customGray-75 border-borders md:bg-white md:hover:bg-customGray-75">
              <div className="mb-2">
                {style.icon}
              </div>
